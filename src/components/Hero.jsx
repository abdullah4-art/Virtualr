...
const Hero = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <p className="mt-20 text-center text-lg text-neutral-500 max-w-4xl">
        Empower your creativity and bring you VR app ideas to life with our intuitive development tools. Get started today and turn  imagination into immersive reality!
      </p>
      ...
      <div className="flex mt-10 justify-center">
        <video
          ...
          loop
          muted
          className="rounded-lg w-1/2 border border-orange-400 mx-2 my-4">
